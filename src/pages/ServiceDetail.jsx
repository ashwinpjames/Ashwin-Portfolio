...
export default function ServiceDetail() {
  ...
  return <main className="service-detail-page" id="main">
    <section className="service-detail-hero"><div className="service-detail-grid" aria-hidden="true"/><div className="container service-detail-inner"><Link className="service-detail-back" to="/services">← Back to services</Link><div className="service-detail-meta"><span className="service-detail-number">{service.number}</span><span className="service-detail-badge">{service.badge ?? 'Growth service'}</span></div><p className="services-eyebrow">Service</p><h1>{service.title}</h1><p className="service-detail-lead">{service.description}</p><a className="service-detail-cta" href={whatsappUrl} target="_blank" rel="noreferrer">Discuss this service <span>↗</span></a></div></section>
