...
function useAboutMotion() {
  ...
  useEffect(() => {
    ...
    if (reduced) { revealNodes.forEach((node) => node.classList.add('in-view')); return undefined }
    ...
    let frame = 0
    const updateParallax = () => { const y = window.scrollY; parallaxNodes.forEach((node) => { const speed = Number(node.dataset.aboutParallax || 0); node.style.transform = `translate3d(0, ${y * speed}px, 0)` }); frame = 0 }
...
export default function About() {
  ...
  return <main ref={rootRef} className="about-page about-editorial">
    <section className="about-hero-react" id="about-hero">
      <div className="about-base-react" /><div className="about-blobs-react" data-about-parallax="0.04" aria-hidden="true"><div className="about-blob-react one" /><div className="about-blob-react two" /><div className="about-blob-react three" /><div className="about-blob-react four" /><div className="about-blob-react five" /></div><div className="about-grid-react" data-about-parallax="0.015" /><div className="about-sheen-react" /><div className="about-noise-react" />
    ...
    <section className="about-section about-experience-section"><div className="container"><div className="about-section-heading about-editorial-heading about-reveal"><p className="home-eyebrow">Experience across industries</p><h2>Different businesses. The same focus on qualified growth.</h2><p>I have worked across service businesses where acquisition, trust, lead quality and conversion have to work together.</p></div><div className="about-industry-marquee" aria-label="Industries Ashwin has worked across"><div className="about-industry-track"><div className="about-industry-set">{industries.map((industry) => <span key={`industry-a-${industry}`}>{industry}</span>)}</div><div className="about-industry-set" aria-hidden="true">{industries.map((industry) => <span key={`industry-b-${industry}`}>{industry}</span>)}</div></div></div></div></section>
    <section className="about-section about-brands-section"><div className="container"><div className="about-brands-heading about-reveal"><div><p className="home-eyebrow">Selected experience</p><h2>Businesses and brands I have worked with.</h2></div><p>A selection of the businesses represented in my professional experience across acquisition, lead generation, websites and growth systems.</p></div><div className="about-brand-editorial" aria-label="Brands Ashwin has worked with"><div className="about-brand-track"><BrandSet /><BrandSet /></div><div className="about-brand-track reverse" style={{ marginTop: '.8rem' }}><BrandSet reverse /><BrandSet reverse /></div></div></div></section>
    <section className="about-section about-work-section"><div className="container"><div className="about-section-heading about-editorial-heading about-reveal"><p className="home-eyebrow">How I work</p><h2>Senior thinking. Hands on delivery. Clear accountability.</h2><p>You work directly with the person shaping the strategy and improving the work, not a chain of account managers.</p></div><div className="about-three-points">{principles.map(([number, title, text], index) => <article className="about-point about-reveal" style={{ transitionDelay: `${index * 70}ms` }} key={number}><span className="about-point-number">{number}</span><h3>{title}</h3><p>{text}</p></article>)}</div></div></section>
    <section className="about-section about-proof-section"><div className="container about-proof-layout"><div className="about-proof-copy about-reveal"><p className="home-eyebrow">The work in practice</p><h2>From acquisition to the qualified conversation.</h2><p>Good <a href="https://www.salesforce.com/marketing/performance-marketing/" target="_blank" rel="noreferrer">performance marketing</a> is not just about buying traffic. It is about connecting targeting, creative, landing pages, tracking and sales follow up into one measurable system.</p></div><div className="about-proof-panel about-reveal" style={{ transitionDelay: '.12s' }} aria-label="Illustrative growth system dashboard"><div className="about-proof-window"><div className="about-proof-window-top"><span>Growth system</span><span>CONNECTED</span></div><div className="about-proof-metrics"><div className="about-proof-metric"><strong>CPA</strong><span>Acquisition signal</span></div><div className="about-proof-metric"><strong>CQL</strong><span>Lead quality</span></div><div className="about-proof-metric"><strong>CRO</strong><span>Conversion layer</span></div></div><div className="about-proof-bars"><div className="about-proof-bar"><i /></div><div className="about-proof-bar"><i /></div><div className="about-proof-bar"><i /></div></div></div></div></div></section>
    <section className="about-section about-expectations-section"><div className="container about-expectations-editorial"><div className="about-section-heading about-reveal"><p className="home-eyebrow">What you can expect</p><h2>A practical partnership built around progress.</h2></div><div className="about-expectation-list">{expectations.map(([title, text], index) => <article className="about-expectation-editorial about-reveal" style={{ transitionDelay: `${index * 60}ms` }} key={title}><strong>{title}</strong><p>{text}</p></article>)}</div></div></section>
    <section className="about-section about-final-cta"><div className="container about-final-cta-inner"><p className="home-eyebrow about-reveal">The right fit</p><h2 className="about-reveal">If you want more clarity and momentum, let’s talk.</h2><p className="about-reveal">Bring the constraint that is getting in the way. We’ll identify the most useful next move.</p><a className="about-fit-button about-reveal" href={whatsappUrl} target="_blank" rel="noreferrer">Start a conversation <span>↗</span></a></div></section>
  </main>
}
