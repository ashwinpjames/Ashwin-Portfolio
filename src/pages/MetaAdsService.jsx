...
export default function MetaAdsService() {
  return <main className="meta-service-page" id="main">
    <section className="meta-service-hero"><div className="meta-service-grid" aria-hidden="true"/><div className="container meta-service-hero-inner">
      ...
      <h1>Meta Ads Management Dubai That Turns Attention Into Qualified Leads</h1>
      <p className="meta-service-hero-lead">Facebook and Instagram can create demand before someone searches for your service. I build Meta campaigns around the audience, offer, creative and lead quality signals needed to turn that attention into useful conversations.</p>
