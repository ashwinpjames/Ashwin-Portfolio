...
const relatedLinks = [
  { to: '/services/lead-generation', label: 'Lead Generation', description: 'Turn paid social demand into a connected acquisition system.' },
  { to: '/services/cro', label: 'CRO', description: 'Improve what happens after the ad click.' },
  { to: '/case-studies/meta-pixel-capi-signal-loss', label: 'Meta Tracking Case Study', description: 'Explore the measurement side of Meta Ads.' },
  { to: '/services/hubspot', label: 'HubSpot CRM & Automation', description: 'Connect lead quality and sales follow up.' },
  { to: '/services/google-ads', label: 'Google Ads', description: 'Capture existing high intent demand.' },
  { to: '/resources/meta-ads-launch-checklist', label: 'Meta Ads Launch Checklist', description: 'Use the practical pre launch resource.' },
]
...
export default function MetaAdsService() {
  return <main className="meta-service-page" id="main">
    <section className="meta-service-hero"><div className="meta-service-grid" aria-hidden="true"/><div className="container meta-service-hero-inner">
      <div className="meta-hero-layout"><div className="meta-hero-copy"><p className="meta-service-eyebrow">Meta Ads Management · Dubai & UAE</p><h1>Meta Ads That Turn Attention Into <span>Qualified Leads.</span></h1><p className="meta-service-hero-lead">I build Facebook and Instagram campaigns around audience, offer, creative and lead quality signals so paid social creates useful conversations, not just cheap enquiries.</p><a className="meta-service-primary" href={whatsappUrl} target="_blank" rel="noreferrer">Book a Free 15 Minute Meta Ads Audit <span>↗</span></a><p className="meta-service-trust">No obligation · Hands on management · Audience strategy · Creative direction · Lead qualification</p></div></div>
    </div></section>
    ...
    <RelatedLinks eyebrow="Continue exploring" title="Meta Ads related services and resources" links={relatedLinks} />
