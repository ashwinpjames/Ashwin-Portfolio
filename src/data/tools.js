...
export const tools = [
  ...
  { id: 'meta-ads-launch-checklist', title: 'Meta Ads Launch Checklist', description: 'A practical 10-stage checklist covering tracking, campaign structure, audiences, creative, landing pages and post-launch optimisation.', type: 'Checklist', category: 'frameworks', platforms: ['meta'], route: '/resources/meta-ads-launch-checklist', icon: '✓', status: 'live' },
  ...
  { id: 'utm-builder', title: 'UTM Builder', description: 'Build consistent campaign tracking parameters for paid media, content and partner campaigns.', type: 'Tool', category: 'analytics', platforms: ['meta', 'google', 'analytics', 'hubspot'], route: '/resources/utm-builder', icon: '⌘', status: 'live' },
