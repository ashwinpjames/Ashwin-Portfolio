...
export const tools = [
  ...
  { id: 'invoice-generator', title: 'Free Invoice Generator', description: 'Create professional invoices for freelance marketing services, client retainers and consulting work, then print or save them as PDF.', type: 'Tool', category: 'calculators', platforms: ['website'], route: '/resources/invoice-generator', icon: '▤', status: 'live', featured: true },
]
