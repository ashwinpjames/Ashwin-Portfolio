...
export const tools = [
  ...
  { id: 'utm-builder', title: 'UTM Builder', description: 'Build consistent campaign tracking parameters for paid media, content and partner campaigns.', type: 'Tool', category: 'analytics', platforms: ['meta', 'google', 'analytics', 'hubspot'], route: '#', icon: '⌘', status: 'coming-soon' },
