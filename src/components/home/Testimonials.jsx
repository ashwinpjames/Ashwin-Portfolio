...
export default function Testimonials() {
  return <section id="testimonials" className="home-section testimonials-section"><div className="container"><div className="section-heading split-heading reveal-home"><div><p className="home-eyebrow">Client perspectives</p><h2>Results matter. So does the way we get there.</h2></div><div className="testimonials-heading-actions"><p>A few words from growth minded teams.</p><div className="google-review-actions"><a className="google-business-link" href={googleBusinessUrl} target="_blank" rel="noreferrer">View Google profile ↗</a><a className="google-review-button" href={googleReviewUrl} target="_blank" rel="noreferrer" aria-label="Leave a Google review">Leave a review ↗</a></div></div></div></div><div className="testimonial-marquee" aria-label="Client reviews"><div className="testimonial-track"><Cards /><Cards hidden /></div></div></section>
}
